...
/**
 * Servlet implementation class returnMyBookServlet
 */
@WebServlet("/returnMyBook")
public class returnMyBookServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public returnMyBookServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean result = service.getReturnMyBook(isbn);
