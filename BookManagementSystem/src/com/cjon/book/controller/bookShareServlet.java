...
/**
 * Servlet implementation class bookShareServlet
 */
...
public class bookShareServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// 1. 입력받고
		String shareKeyword = request.getParameter("shareKeyword"); // 책에 대한 keyword를 받는부분
		...
		String result = service.getShareList(shareKeyword);
